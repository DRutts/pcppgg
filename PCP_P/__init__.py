...
class InstructionsWaitPage(WaitPage):
    ...
    body_text = "{len(waiting_players)} of 4 players ready. Please wait for the other players to join. The waiting time will take at most 5 minutes." 
...
class Inter_RoundWaitPage(WaitPage):
    ...
    body_text = "len(waiting_players)} of 4 players ready. Please wait for the other players to join. The waiting time will take at most 30 seconds."
...
class ResultsWaitPage(WaitPage):
    body_text = "len(waiting_players)} of 4 players ready. Please wait for the other players to join. The waiting time will take at most 1 minute."
...
class PunishmentWaitPage(WaitPage):
    ...
    body_text = "len(waiting_players)} of 4 players ready. Please wait for the other players to join. The waiting time will take at most 3 minutes."
